// import { getSixMonthsAQTrendAction } from "@/app/ServerActions/AirQualityServerActions";
// import {
...
// 	return new Date(date).toLocaleDateString(localLanguage, {
// 		month: "short"
// 	});
// }
...
// 		// .filter((singlePoint) => {
// 		// 	return getPointValue(singlePoint, selectedPollut) !== null;
// 		// })
// 		// .slice(-24);
// 	}, [monthsResult, selectedPollut]);
...
// 							{t("common.source")} {monthsResult.source}
// 						</p>
// 					)}
// 				</div>
// 			</header>
...
// 					return (
// 						<Fragment key={singleOpt.code}>
// 							<button
// 								key={singleOpt.code}
// 								type="button"
// 								className={
// 									selectedPollut === singleOpt.code
// 										? styles["activePollut"]
// 										: styles["pollutBtn"]
// 								}
...
// 				<div className={styles["errorBox"]}>{monthsResult.error}</div>
// 			)}
...
// 									{singleValue !== null ? singleValue.toFixed(1) : "-"}
// 								</p>
// 							</div>
// 						);
// 					})}
